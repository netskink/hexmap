...
final class LevelScene: SKScene {
    ...
    internal var map: SKTileMapNode!         // The terrain tile map from your .sks
    ...
    internal var debugDots: [SKNode] = []    // Track dots so we can clear them
    internal let touchViz = TouchVisualizer()
    #endif
    ...
    internal func isInBounds(_ c: Int, _ r: Int) -> Bool {
    ...
    internal func nearestSixNeighbors(from c0: Int, r0: Int) -> [(Int, Int)] {
